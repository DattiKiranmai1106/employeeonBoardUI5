		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapktempemponboard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapktempemponboard-display": {
								"semanticObject": "comsapktempemponboard",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.kt.emp.emponboard",
									"url": sap.ui.require.toUrl("com/sap/kt/emp/emponboard")
								}
							}
						}
					}
